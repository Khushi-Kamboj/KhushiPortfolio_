      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center">
        <div className="animate-fade-in-up">
          <Image
            ...
            className="rounded-full mx-auto mb-6 border-4 border-primary/50 shadow-lg"
          />
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4 animate-fade-in-up [animation-delay:0.5s]">
